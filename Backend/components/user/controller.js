...
function singUp(name, password, password2, email, photo, push_notifactions_token){
    return new Promise((resolve, reject)=>{
        ...
        .then(x => {
            ...
            store.add({name, password:_newPassword , email, photo: photo_url, push_notifactions_token})
            .then(resp =>{
